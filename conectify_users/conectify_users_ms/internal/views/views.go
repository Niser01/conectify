...
type View_interface interface {
	...
	Update_photoId(ctx context.Context, id int, photoId string) error

	Update_userByid(ctx context.Context, id int, names string, lastNames string, photoId string, eMail string, status int, phoneNumber string, SSO_UserId string) error
